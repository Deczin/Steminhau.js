...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    if (!interaction.member.permissions.has(Discord.PermissionFlagsBits.SendMessages)) {
        ...
        const cores = { // Coloque o ID do cargo em cada variável
            ...
            azul: interaction.guild.roles.cache.get('1161867621738762361'),
            vermelho: interaction.guild.roles.cache.get('1160977343037329529'),
            ...
            rosa: interaction.guild.roles.cache.get('1161868291434889306'),
