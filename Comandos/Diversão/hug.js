...
module.exports = {
    ...
    run: async (client, interaction, args) => {
        ...
        let embed = new Discord.EmbedBuilder()
            .setDescription(`**<:aquacry:1159540873193861220> ${interaction.user} abraçou  ${user}.**`)
            .setImage(`${random1}`)
            .setColor("#FF1493")
        ...
        let embed1 = new Discord.EmbedBuilder()
            .setDescription(`**<:kannabear:1159540895608225914> ${user} Retribuiu o abraço de ${interaction.user}.**`)
            .setColor("#FF1493")
            .setImage(`${random2}`);
