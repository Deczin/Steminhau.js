...
client.on('messageReactionAdd', (react, user) => {
    ...
    const cores = { // Coloque o ID do cargo em cada variável
        ...
        azul: client.guilds.cache.get(react.message.channel.guildId).roles.cache.get('1161867621738762361'),
        vermelho: client.guilds.cache.get(react.message.channel.guildId).roles.cache.get('1160977343037329529'),
        ...
        rosa: client.guilds.cache.get(react.message.channel.guildId).roles.cache.get('1161868291434889306'),
    ...
    if (react.message.channel.id === '1161876233857024040') { // ID DO CANAL DA MENSAGEM
